...
<div class="form">
	<?php echo form::label('profile', $labels['profile']); ?>
	<?php echo form::input('profile', $drug->profile, array('id' => 'profile')); ?>
</div>

<div class="form">
	<?php echo form::label('action_mechanism', $labels['action_mechanism']); ?>
	<?php echo form::input('action_mechanism', $drug->action_mechanism, array('id' => 'action_mechanism')); ?>
</div>

<div class="form">
	<?php echo form::label('indications', $labels['indications']); ?>
	<?php echo form::input('indications', $drug->indications, array('id' => 'indications')); ?>
</div>

<div class="form">
	<?php echo form::label('precautions', $labels['precautions']); ?>
	<?php echo form::input('precautions', $drug->precautions, array('id' => 'precautions')); ?>
</div>

<div class="form">
	<?php echo form::label('side_effects', $labels['side_effects']); ?>
	<?php echo form::input('side_effects', $drug->side_effects, array('id' => 'side_effects')); ?>
</div>

<div class="form">
	<?php echo form::label('interactions', $labels['interactions']); ?>
	<?php echo form::input('interactions', $drug->interactions, array('id' => 'interactions')); ?>
</div>

<div class="form">
	<?php echo form::label('diet_parameters', $labels['diet_parameters']); ?>
	<?php echo form::input('diet_parameters', $drug->diet_parameters, array('id' => 'diet_parameters')); ?>
</div>

<div class="form">
	<?php echo form::label('dosage', $labels['dosage']); ?>
	<?php echo form::input('dosage', $drug->dosage, array('id' => 'dosage')); ?>
</div>

<div class="form">
	<?php echo form::label('action', $labels['action']); ?>
	<?php echo form::input('action', $drug->action, array('id' => 'action')); ?>
</div>

<div class="form">
	<?php echo form::label('overdose', $labels['overdose']); ?>
	<?php echo form::input('overdose', $drug->overdose, array('id' => 'overdose')); ?>
</div>

<div class="form">
	<?php echo form::label('chronic_usage', $labels['chronic_usage']); ?>
	<?php echo form::input('chronic_usage', $drug->chronic_usage, array('id' => 'chronic_usage')); ?>
</div>

<div class="form">
	<?php echo form::label('attention_points', $labels['attention_points']); ?>
	<?php echo form::input('attention_points', $drug->attention_points, array('id' => 'attention_points')); ?>
</div>

<div class="form">
	<?php echo form::label('storage', $labels['storage']); ?>
	<?php echo form::input('storage', $drug->storage, array('id' => 'storage')); ?>
</div>
