...
class Model_Drug extends ORM {
	...
	public function defaults()
	{
		...
		$this->dosage = '<strong><span style="text-decoration:underline;">Χορήγηση από το στόμα (p.o.):</span></strong>'
			.'<br /><br /><strong>Ενήλικες:</strong><br /><br />'
		...
		$this->side_effects = '<strong>Συχνότητα:</strong> εμφανίζεται συχνά. <br /><br />'
			.'<strong>Ειδοποιήστε το γιατρό σε:</strong> ένταση ή επιμονή.';
